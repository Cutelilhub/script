getgenv().Cutelilhub = nil
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Cutelilhub/script/refs/heads/main/Fluent.lua"))()
local crypt = loadstring(game:HttpGet("https://raw.githubusercontent.com/Cutelilhub/script/refs/heads/main/sha256.lua"))()
...
function LoadCarbon()
	...
	function ExplodePos(pos, justLag)
		if justLag == true then
			print("JustLag")
			Remotes["ExplosiveEvent"]:FireServer("Cutelil-On-Top", pos, 0, 0, 0, nil, nil, nil, nil, nil, nil,nil, "Auth", nil)
		else
			print("Kill")
			Remotes["ExplosiveEvent"]:FireServer("Cutelil-On-Top", pos, 500000, 120, 120, nil, nil, nil, nil, nil, nil,nil, "Auth", nil)
		end
	end
...
WorkingPlaces["5470087938"][2] = function()
	...
	local NewAnimator = loadstring(request({ Method="GET", Url="https://raw.githubusercontent.com/Cutelilhub/script/refs/heads/main/Animator.lua" }).Body)()
		...
		while task.wait() do
			...
			if LOOP_STATUS["GRABP1"] then
				...
				if p1 and LocalPlayer.Character then
					if Players:FindFirstChild("dooyoun1004") then
						task.wait(1)
...
if LocalPlayer.Name == "dooyoun1004" then
...
if LocalPlayer.Name ~= "dooyoun1004" then
	if Players:FindFirstChild("dooyoun1004") then
		...
		Players:FindFirstChild("dooyoun1004").Chatted:Connect(function(message)
			print(message.." For")
			print(message == "quit")
	...
	Players.PlayerAdded:Connect(function(player)
		if player.Name == "dooyoun1004" then
			Fluent:Notify({
				Title = "Dynamic Handler",
